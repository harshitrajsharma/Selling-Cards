    ...
    <div className='flex flex-col-reverse md:flex-row border-2 p-8 gap-6 border-gray-800  bg-[#2c282885] rounded-xl'>
      <div className='flex flex-col  justify-center gap-6 py-4 md:w-[40%]'>
        ...
        <p className=' text-gray-300'>
          Whop seamlessly intergrates with various digital platforms, simplifying the process of selling just about anything!
        </p>
        <div>
          <button className='text-white px-4 py-1 border-2 font-bold rounded bg-[#2d272785] hover:bg-[#2d2727ab] border-gray-800 hover:border-gray-900 hover:scale-[1.05]'>View all apps</button>
        </div>
      </div>
